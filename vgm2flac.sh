...
ext_vgmstream="aa3|acb|adp|adpcm|ads|adp|adx|aif|aifc|aix|ast|at3|at9|bcstm|bcwav|bfstm|bfwav|bik|bnk|bwav|cfn|dsp|eam|fsb|genh|grn|hca|his|hps|idmsf|imc|int|laac|logg|ktss|mib|mpf|msadpcm|msf|mus|mtaf|rak|raw|rsf|sad|sfd|sgd|smk|sng|spsd|str|ss2|tak|thp|txtp|vag|vgs|vpk|wem|xvag|xwav|xwb"
ext_zxtune_gbs="gbs"
ext_zxtune_nsf="nsf"
ext_zxtune_sid="sid"
